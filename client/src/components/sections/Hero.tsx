          ...
          <div className="flex flex-col gap-6 max-w-2xl">
            ...
            <div className="flex items-center gap-4 pt-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-500">
              ...
              <div className="flex items-center gap-3">
                <a href="https://github.com/banothuvinodkumar" target="_blank" rel="noreferrer" className="p-2 rounded-full bg-card border border-border hover:border-primary/50 hover:text-primary transition-colors">
                  <Github className="w-5 h-5" />
                </a>
                <a href="https://www.linkedin.com/in/vinod-kumar-banothu-559a14325" target="_blank" rel="noreferrer" className="p-2 rounded-full bg-card border border-border hover:border-primary/50 hover:text-primary transition-colors">
                  <Linkedin className="w-5 h-5" />
                </a>
                <a href="mailto:itsvinodkumarcse@gmail.com" className="p-2 rounded-full bg-card border border-border hover:border-primary/50 hover:text-primary transition-colors">
